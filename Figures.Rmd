...
fig1 <- ggplot(data=datos0) + 
  ...
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
        legend.title = element_text(size=10, face="bold", colour = "black"), # CHANGE LEGEND TITLE
        legend.text = element_text(size=8, colour = "black")) # CHANGE LEGEND TEXT
...
fig1 <- ggplot(data = datos.multi) +
  ...
  labs(y= "Density", x = "Time", subtitle = "a) Global distribution") + #CHANGE AXIS TAGS
  ylim(0,0.004) +
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
...
fig2 <- ggplot(data = datos.multi %>% group_by(Hospital)) +
  ...
  ylim(0,0.004) +
  labs(y= "Density", x = "Time", subtitle = "b) Distribution per Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig1 <- ggplot(datos.multi %>% group_by(Hospital), aes(TimeEventACLForTransplant, fill=Hospital)) +
      ...
      coord_flip() +
      scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
      labs(title="TEAOT Boxplot", x = "TEAOT", y = "Hospital") + #CHANGE AXIS TAGS
      theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
            axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
            axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
            panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig2 <- ggplot(datos.multi %>% group_by(Hospital), aes(ULN, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="ULN Boxplot", x = "ULN", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig3 <- ggplot(datos.multi %>% group_by(Hospital), aes(MELD, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="MELD Boxplot", x = "MELD", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig4 <- ggplot(datos.multi %>% group_by(Hospital), aes(AlbgDL, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="AlbgDL Boxplot", x = "AlbgDL", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig5 <- ggplot(datos.multi %>% group_by(Hospital), aes(INR, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="INR Boxplot", x = "INR", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig6 <- ggplot(datos.multi %>% group_by(Hospital), aes(Br, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="Br Boxplot", x = "Br", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig7 <- ggplot(datos.multi %>% group_by(Hospital), aes(Cr, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="Cr Boxplot", x = "Cr", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig8 <- ggplot(datos.multi %>% group_by(Hospital), aes(Age, fill=Hospital)) +
  ...
  coord_flip() +
  scale_fill_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
  labs(title="Age Boxplot", x = "Age", y = "Hospital") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig1 <- ggplot(datos.multi, 
  ...
  labs(title="Hospital Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig2 <- ggplot(datos.multi, 
  ...
  geom_bar(position=position_dodge()) +
  labs(title="AOT Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig3 <- ggplot(datos.multi %>% group_by(Hospital), 
  ...
  geom_bar(position=position_dodge()) +
  labs(title="Sex Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig4 <- ggplot(datos.multi %>% group_by(Hospital), 
  ...
  scale_fill_manual(values=c("#4169E1","#DB7093")) +
  geom_bar(position=position_dodge()) +
  labs(title="Diabetes Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig5 <- ggplot(datos.multi %>% group_by(Hospital), 
  ...
  geom_bar(position=position_dodge()) +
  labs(title="Aet. Cat. Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig6 <- ggplot(datos.multi %>% group_by(Hospital), 
  ...
  geom_bar(position=position_dodge()) +
  labs(title="Chil. Pugh. Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig7 <- ggplot(datos.multi %>% group_by(Hospital), 
  ...
  geom_bar(position=position_dodge()) +
  labs(title="Bblockers Distribution", y= "", x = "") + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
ggplot(ma, aes(x=x1, y=y2, col=Hospital)) +
 ...
 scale_colour_manual(values=c("#4169E1","#DB7093", "#66CDAA")) +
 geom_line(aes(y=Lim, x=1:725),colour="purple") + # ADD HORIZONTAL LINE
 geom_text(aes(label=1:725),hjust=-0.5, vjust=0, size=3) + # ADD NUMBERS TO POINTS
 labs(title="", y= "Mahalanobis distance", x = "Index") + #CHANGE AXIS TAGS
 theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
       axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
       axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
       panel.border = element_rect(colour = "black", fill=NA, size=0.3)) # CHANGE BORDERS
...
ggcorrplot(cor, p.mat = pmat, show.diag = F, type="lower", lab=TRUE, lab_size=6, tl.cex = 12,
          colors = c("#4169E1", "white", "#DB7093")) + #CHANGE AXIS TAGS
labs(x="", y="") +
theme(panel.background = element_rect(fill = "lightgray",colour = "lightgray"),
     plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
     axis.title.x = element_text(size=0, face="bold", colour = "black"), # CHANGE X AXIS STYLE
     axis.title.y = element_text(size=0, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
     panel.border = element_rect(colour = "black", fill=NA, size=0.3)) # CHANGE BORDERS
```
...
fig1.1 <- ggplot(data=datos.multi %>% filter(Hospital=="RFH")) +
    ...
    theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
          ...
          panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
          legend.title = element_text(size=10, face="bold", colour = "black"), # CHANGE LEGEND TITLE
          legend.text = element_text(size=8, colour = "black"),legend.position ="none") # CHANGE LEGEND TEXT   
...
fig1 <- ggplot(data = datos.multi) +
  ...
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        ...
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
        legend.title = element_text(size=10, face="bold", colour = "black"), # CHANGE LEGEND TITLE
        legend.text = element_text(size=8, colour = "black"), legend.position = 0, # CHANGE LEGEND TEXT   
...
fig2 <- ggplot(data = datos.multi) +
      ...
      theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
            ...
            panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
            legend.title = element_text(size=10, face="bold", colour = "black"), # CHANGE LEGEND TITLE
            legend.text = element_text(size=8, colour = "black"),legend.position = c(0.9, 0.7), # CHANGE LEGEND TEXT   
...
fig1 <- ggplot(beta1.results, aes(x=Model, y=Mean, col=Model)) + 
  ...
  geom_pointrange(aes(ymin=Lower, ymax=Upper)) + #CHANGE AXIS TAGS
  theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
        axis.title.x = element_text(size=14, face="bold", colour = "black"), # CHANGE X AXIS STYLE
        axis.title.y = element_text(size=14, face="bold", colour = "black"), # CHANGE Y AXIS STYLE
        panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
...
fig1 <- ggplot(data = datos.multi) +
    ...
    theme(plot.title = element_text(size=14, face= "bold", colour= "grey43", hjust = 0.5), # CHANGE TITLE STYLE
          ...
          panel.border = element_rect(colour = "black", fill=NA, size=0.3), # CHANGE BORDERS
          legend.title = element_text(size=10, face="bold", colour = "black"), # CHANGE LEGEND TITLE
          legend.text = element_text(size=8, colour = "black"),legend.position = c(0.9, 0.8)) # CHANGE LEGEND TEXT     
